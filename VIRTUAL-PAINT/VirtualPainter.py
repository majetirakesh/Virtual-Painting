...
def virtual_Painter():
    ...
    while True:
        ...
        if len(lmList) != 0:
                ...
                if drawColor == (0, 0, 0):
                    ...
                    if shape == 'rectangle':
                        ...
                        if result < 0:
                            result = -1 * result
                        u = result
                        cv2.rectangle(img, (x0, y0), (x1, y1), drawColor,brushThickness)
                        ...
                        if fingers[4]:
                            cv2.rectangle(imgCanvas, (x0, y0), (x1, y1), drawColor,brushThickness)
                            cv2.circle
                            time.sleep(0.5)
                    ...
                    if shape == 'circle':
                        ...
                        cv2.circle(img,(x0,y0),u,drawColor,brushThickness)
                        if fingers[4]:
                            cv2.circle(imgCanvas, (x0, y0), u, drawColor,brushThickness)
                            time.sleep(0.5)
                    ...
                    if shape == 'elipse':
                        ...
                        if b<0:
                            b=-1*b
                        cv2.ellipse(img, (x1, y1),(a,b), 0,0,360,drawColor,brushThickness)
                        ...
                        if fingers[4]:
                            cv2.ellipse(imgCanvas, (x1, y1), (a, b), 0, 0, 360,drawColor,brushThickness)
                            time.sleep(0.5)
            ...
            if fingers[0] and fingers[4] and fingers[1]==0 and fingers[2]==0 and fingers[3]==0:
                exit()
            if fingers[0]==0 and fingers[1] and fingers[2] and fingers[3] and fingers[4]:
                for img_number in range(10):
                    if(os.path.exists("./VP"+str(img_number)+".jpg")):
                        img_number += 1
                    else:
                        cv2.imwrite("./VP"+str(img_number)+".jpg",imgCanvas)
                        time.sleep(0.7)
                        break
